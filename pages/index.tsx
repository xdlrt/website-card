  ...
  return (
    <div className="h-screen w-full pb-12 md:pb-4 flex flex-col items-center bg-slate-50 dark:bg-slate-900 transition-all duration-300">
      ...
      <nav className="w-full container mx-auto px-10 py-6 flex items-center justify-between select-none">
        <div className="flex items-center text-indigo-600 dark:text-indigo-500 font-bold text-2xl lg:text-4xl">
          Website Card
        </div>
        <div className="cursor-pointer">
          ...
          <div onClick={() => setCurrentMode(false)}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6 hidden dark:block dark:text-white"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              strokeWidth={2}
      ...
      <footer className="w-full text-sm text-center mt-4 pb-1 ease-in select-none">
        <div className="max-w-screen-xl mx-auto px-4">
          <div className="pt-8 flex max-w-xs mx-auto items-center justify-center">
            ...
            <span className="ml-4 transition-colors duration-200 text-gray-400 hover:text-gray-800 dark:hover:text-white cursor-pointer no-underline hover:no-underline">
              @yeshu
            </span>
          </div>
        </div>
